...
![](.\Chapter3_Image\Chapter3_017_图像标签_01.png)
...
2. 内部链接：网站内部页面之间的相互链接。直接链接内部页面名称即可 比如 < a href="index.html"> 首页
...
5. 网页元素链接：在网页中的各种网页元素。如文本、图像、表格、音频、视频等。
   ...
   1.` <a href="http://www.baidu.com"><imag src="imag.jpg"></a>` 点击这个图片， 就可以进入 baidu 这个 页面了
